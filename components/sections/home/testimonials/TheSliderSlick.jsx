...
function SampleNextArrow(props) {
  ...
  return (
    <svg
      width="36"
      onClick={onClick}
      className="absolute bottom-[-45px] z-20 ml-[15px] rotate-180 cursor-pointer lg:top-[370px] lg:ml-[10px]"
      height="16"
      viewBox="0 0 36 16"
      fill="none"
...
function SamplePrevArrow(props) {
  ...
  return (
    <svg
      width="36"
      onClick={onClick}
      className="absolute bottom-[-45px] z-20 ml-[80px] cursor-pointer lg:top-[370px] lg:ml-[70px]"
      height="16"
      viewBox="0 0 36 16"
      fill="none"
      xmlns="http://www.w3.org/2000/svg"
